...
void ZXing_ReaderOptions_setReturnCode128Details(ZXing_ReaderOptions* opts, bool returnCode128Details);
...
bool ZXing_ReaderOptions_getReturnCode128Details(const ZXing_ReaderOptions* opts);
